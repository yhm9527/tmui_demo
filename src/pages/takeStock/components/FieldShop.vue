 ...
 * @LastEditTime: 2024-01-25 17:06:48
 * @FilePath: \tmui_cli_demo\src\pages\takeStock\components\FieldShop.vue
 * @Description:
 *
...
<script setup lang="ts">
    ...
    onMounted(() => nextTick(() => {
        ...
        if(formData && !formData.value.ckdm) formData.value.ckdm = shopData?.Khdm
    }))
</script>
<script lang="ts">
    export default {
